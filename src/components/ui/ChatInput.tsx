  ...
  return (
    <div className="flex items-end gap-2 px-3 py-2.5">
      <textarea
        ...
        className={cn(
          // 参考图挂件的输入:胶囊形浅灰底
          "min-h-9 flex-1 resize-none rounded-3xl bg-surface px-4 py-2 text-[0.9375rem] leading-relaxed",
          "placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/20",
        )}
      />
      <button
        type="button"
        ...
        className={cn(
          ...
          canSend ? "bg-ink text-white hover:bg-ink/85" : "bg-muted text-muted-foreground",
        )}
      >
